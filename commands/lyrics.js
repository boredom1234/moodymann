...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    SongTitle = SongTitle.replace(
      /lyrics|lyric|lyrical|video|official music video|\(official music video\)|audio|\(video\)|official|official video|official video hd|official hd video|offical video music|\(offical video music\)|extended|hd|(\[.+\])/gi,
      ""
    );
